...
Здесь вы увидите выжимки из технических заданий для разработчиков, различные диаграммы в двух нотация, а также мой мини-пэт проект.

## Технологический стек:
1С, BPMN,UML, API(REST),Postman/
