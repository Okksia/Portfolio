...
## 💼  Кейсы
**1.База продажи квартир с автоматизацией бронирования**
...
(задание с собеседования, было интересно оформить его после на бумаге).
### Решение:
...
**СостояниеКвартиры**  
Регистры сведений:
Тип: сведений, периодический
Подчинение: регистратору (Бронь, Платёж)
Ресурсы: СостояниеКвартиры
Измерения: квартира

**РасчетыСПокупателями**  
Регистры накопления:
Тип: накопления, обороты
Подчинение: регистратору (Платеж)
Ресурсы: цена
Измерения: квартира
