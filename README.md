...
|---------|-------------------|-------------|
| **Системы** | 1C: объекты конфигурации, консоль запросов, БСП/ERP | Конфигуратор 1С |
| **Диаграммы** | BPMN, UML, ERD-диаграммы | PlantUML, draw.io |
| **Базы данных** | SQL (MySQL, PostgreSQL, SQLite), оптимизация запросов | DBeaver |
| **Интеграции** | REST API, Telegram Bot API | Postman, Python |  
