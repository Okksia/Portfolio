...
**[1. Конверсия брони](docs/конверсия.mcr)**  
Анализ эффективности: сколько броней превращается в реальные договоры купли-продажи.  

**[2. Эффективность менеджеров](docs/эффективность_менеджеров_продаж.mcr)**  
Рейтинг менеджеров по конверсии бронь→договор для премирования и обучения слабых.  

**[3. Загруженность квартир по статусам](docs/Загруженность_квартир_по_статусам.mcr)**  
Текущее состояние портфеля квартир: сколько доступно для продажи, забронировано и продано. 

**[4. Сгоревшие брони](docs/Сгоревшие_брони.mcr)** 
