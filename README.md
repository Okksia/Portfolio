...
Здесь вы сможете ознакомиться с примерами написанной мной документации (технические задания, пользовательские инструкции), некоторые диаграммы в двух нотация, а также мой мини-пэт проект.
...
# 🎯 Кейсы & проекты
Здесь представлены примеры написанной мной документации, а также реальные кейсы с собеседований (как я их решила) и пэт-проекты.
...
## 💼  Кейсы
**1.База продажи квартир с автоматизацией бронирования (собеседование)**
**Задача:** Разработать структуру конфигурации для продажи квартир: менеджеры вносят квартиры, бронируют на 7 дней, затем договор+оплата. Автоматический контроль состояний.
**Решение:**
*Объекты конфигурации:*
Справочники: Квартиры (адрес, площадь, цена), Клиенты, Менеджеры
Документы: Бронь, Договор, Платеж
Перечисления: СостояниеКвартиры
Регистры: 
├─ СостояниеКвартиры (сведений, периодический, подчинён регистратору:Бронь, Платёж, ресурс:СостояниеКвартиры, измерение:квартира)
└─ РасчетыСПокупателями (накопления, обороты, подчинён регистратору: Платеж, ресурс: цена, измерение:квартира)
Бизнес-процесс: ПродажаКвартиры (Бронь 7д → Договор → Оплата)

**Точки маршрута БП:**
**Старт Бронь:** Запуск от документа "Бронь". Задача менеджеру: "Заключить договор" (срок 7 дней). Условие перехода: проведен Договор по этой Брони. Состояние квартиры "Забронирована".
**Этап Договор:** Задача менеджеру (заключить), проверка существования Договора.
**Этап Оплата/Завершение:** Задача бухгалтеру: "Зафиксировать платеж" (срок 14 дней). Завершение БП после проведения "Платежа" по Договору. Изменение состояние квартиры "Продано".
