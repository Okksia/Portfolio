...
Здесь вы сможете ознакомиться с примерами написанной мной документации (техничесчик задания, пользовательские интсрукции), некоторые диаграммы в двух нотация, а также мой мини-пэт проект.
...
### 2️⃣ Кейс: База данных покупки квартиры (собеседование)
**Задача:** Спроектировали схему БД для учета недвижимости
- ERD диаграмма
- ТЗ → схема → оптимизация
- [Код SQL / диаграмма]

### 3️⃣ WorkBuddy Bot (пет-проект)
